...
void ThreadMapPort()
{
    ...
    if (r == 1)
    {
        ...
        string strDesc = "MinerSCoin " + FormatFullVersion();
...
static const char *strMainNetDNSSeed[][2] = {
    {"seed.minerscoin.org","seed.minerscoin.com"},
    {NULL, NULL}
};

static const char *strTestNetDNSSeed[][2] = {
    {"seed.minerscoin.org","dnsseed.minerscoin.com"},
    {NULL, NULL}
};
...
bool BindListenPort(const CService &addrBind, string& strError)
{
    ...
    if (::bind(hListenSocket, (struct sockaddr*)&sockaddr, len) == SOCKET_ERROR)
    {
        ...
        if (nErr == WSAEADDRINUSE)
            strError = strprintf(_("Unable to bind to %s on this computer. MinerSCoin is probably already running."), addrBind.ToString().c_str());
        else
